  ...
  <div class="container flex flex-row relative w-full lg:w-4/6 mt-8 h-64 lg:mx-auto">
    ...
    <div class="container absolute h-32 mt-32 px-2">
      <div class="container bg-white h-32 rounded-lg shadow-lg p-4">
        <span class="inline-block bg-teal-200 uppercase text-sm px-2 rounded-full font-bold text-teal-700">
          plus
        </span>
        <span class="inline-block text-gray-500 text-sm font-semibold uppercase">
          3 beds • 2 baths
        </span>
        ...
        <span class="flex flex-row mt-1">
          <span class="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w- text-teal-500" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" focusable="false" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 16 16" style="transform: rotate(360deg);"><path fill-rule="evenodd" d="M8 .25a.75.75 0 0 1 .673.418l1.882 3.815l4.21.612a.75.75 0 0 1 .416 1.279l-3.046 2.97l.719 4.192a.75.75 0 0 1-1.088.791L8 12.347l-3.766 1.98a.75.75 0 0 1-1.088-.79l.72-4.194L.818 6.374a.75.75 0 0 1 .416-1.28l4.21-.611L7.327.668A.75.75 0 0 1 8 .25z" fill="currentColor"></path></svg>
          </span>
          <span class="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w- text-teal-500" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" focusable="false" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 16 16" style="transform: rotate(360deg);"><path fill-rule="evenodd" d="M8 .25a.75.75 0 0 1 .673.418l1.882 3.815l4.21.612a.75.75 0 0 1 .416 1.279l-3.046 2.97l.719 4.192a.75.75 0 0 1-1.088.791L8 12.347l-3.766 1.98a.75.75 0 0 1-1.088-.79l.72-4.194L.818 6.374a.75.75 0 0 1 .416-1.28l4.21-.611L7.327.668A.75.75 0 0 1 8 .25z" fill="currentColor"></path></svg>
          </span>
          ...
          <span class="flex items-center ml-3 text-gray-500">
            34 Reviews
          </span>
        </span>
      </div>
